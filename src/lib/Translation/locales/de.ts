export const de = {
    ...
    Help_Command: "• `/email help` - Diese Hilfenachricht anzeigen",
    Login_Command: "• `/email login` - Bei Ihrem E-Mail-Konto anmelden",
    Logout_Command: "• `/email logout` - Von Ihrem E-Mail-Konto abmelden",
