export const en = {
    ...
    Help_Command: "• `/email help` - Show this help message",
    Login_Command: "• `/email login` - Login to your email account",
    Logout_Command: "• `/email logout` - Logout from your email account",
