export const pl = {
    ...
    Help_Command: "• `/email help` - Pokaż tę wiadomość pomocy",
    Login_Command: "• `/email login` - Zaloguj się do swojego konta e-mail",
    Logout_Command: "• `/email logout` - Wyloguj się z konta e-mail",
