export const ru = {
    ...
    Connect_Account_Message: "🔐 **Подключите свою учетную запись __provider__ к Rocket Chat**\nЕсли хотите использовать учетную запись Outlook, измените Поставщика электронной почты в настройках.",
    ...
    Help_Command: "• `/email help` - Показать это сообщение помощи",
    Login_Command: "• `/email login` - Войти в вашу учетную запись электронной почты",
    Logout_Command: "• `/email logout` - Выйти из учетной записи электронной почты",
