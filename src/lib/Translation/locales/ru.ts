export const ru = {
    ...
    Provider_Changed_Auto_Logout: "Вы были автоматически отключены от **__oldProvider__**.",
    Provider_Change_Warning: "⚠️ Предупреждение: Изменение провайдера электронной почты автоматически отключит вас от текущей учетной записи.",
